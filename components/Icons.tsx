...
export function TwitterIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M22 5.9c-.7.32-1.5.53-2.3.63.83-.5 1.46-1.28 1.76-2.22-.78.46-1.63.8-2.55.98a4.02 4.02 0 0 0-6.85 3.66A11.4 11.4 0 0 1 3.8 4.75a4.02 4.02 0 0 0 1.25 5.36c-.65-.02-1.26-.2-1.8-.5v.05a4.02 4.02 0 0 0 3.23 3.94c-.6.16-1.23.18-1.82.07a4.02 4.02 0 0 0 3.76 2.8A8.07 8.07 0 0 1 2 18.13a11.38 11.38 0 0 0 6.16 1.8c7.4 0 11.44-6.13 11.44-11.44l-.01-.52A8.18 8.18 0 0 0 22 5.9Z" />
    </svg>
  );
}
...
export function SocialIcon({
  name,
  ...props
}: { name: keyof typeof socialIconMap } & IconProps) {
  const Component = socialIconMap[name];
...
export function ServiceIcon({
  name,
  ...props
}: { name: keyof typeof serviceIconMap } & IconProps) {
